...
import type { R_Union_List_schemas_menu_MenuInfoTree___NoneType__ } from '../models/R_Union_List_schemas_menu_MenuInfoTree___NoneType__'
...
export class Service {
   ...
   * @throws ApiError
   */
  public static delMenuMenuIdDelete(id: number): CancelablePromise<R> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/menu/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static addRoleRolePost(requestBody: RoleSchema): CancelablePromise<R> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/role',
      body: requestBody,
   ...
   * 角色信息（权限）
   * @param id
   * @returns R_Union_List_schemas_menu_MenuInfoTree___NoneType__ Successful Response
   * @throws ApiError
   */
  public static getRoleRoleIdGet(
    id: number
  ): CancelablePromise<R_Union_List_schemas_menu_MenuInfoTree___NoneType__> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/role/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static delRoleRoleIdDelete(id: number): CancelablePromise<R> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/role/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static addUserUserPost(requestBody: UserSchema): CancelablePromise<R> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/user',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static delUserUserIdDelete(id: number): CancelablePromise<R> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/user/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static changeRoleUserRoleIdPatch(id: number): CancelablePromise<R> {
    return __request(OpenAPI, {
      method: 'PATCH',
      url: '/user/role/{id}',
      path: {
